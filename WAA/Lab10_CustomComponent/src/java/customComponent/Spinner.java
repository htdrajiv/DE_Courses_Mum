...
public class Spinner extends UIInput {
	...
	public void encodeBegin(FacesContext context) throws IOException {
		...
		writeIncrementButton(writer, clientId);
		writeDecrementButton(writer, clientId);
	...
	public void writeIncrementButton(ResponseWriter writer, String clientId) throws IOException {
		writer.startElement("input", this);
	...
	public void writeDecrementButton(ResponseWriter writer, String clientId) throws IOException {
		writer.startElement("input", this);
		writer.writeAttribute("type", "submit", null);
